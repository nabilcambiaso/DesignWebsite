    ...
    <nav class="header-navbar navbar navbar-with-menu navbar-fixed-top navbar-semi-dark navbar-shadow">
      <div class="navbar-wrapper">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item "><a href="index" class="navbar-brand nav-link"><img alt="branding logo" src="../../assets/img/logo/logo.png"   class="brand-logo logo1" width="150"></a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar"><img src="../../assets/img/logo/logo.png" alt="avatar"></span><span class="user-name text-uppercase UserName"><!--name here --></span><i class="icon-arrow-down-b"></i></a>
    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow mn">
      ...
      <div class="main-menu-content">
        <ul data-menu="menu-navigation" class="navigation navigation-main">
            ...
            <li class="nav-item navigateProducts mt-2 "><a href="./design"><i class="icon-pencil2"></i><span class="sideMenu">Designs</span></a></li>
