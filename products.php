...
<div class="col-xs-6 col-md-4 col-sm-6">
<select  name="selectDesign" id="selectCategoryProducts"  style="width:100%; padding:1px 10px; border-radius:15px; border:solid #EDF8EB;">
...
<div class="container" data-aos="fade-up">
  <div class="section-title text-center">
    ...
    <h2>Products ...</h2>
    <p class="separator">You Can Message Us About The product You Like Just Click On It  </p>
  </div>

  <div class="row productsPic" >
...
<?php footer();?>
<script src="javascriptFiles/products.js"></script>
